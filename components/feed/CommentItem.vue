<template>
  <q-item>
    <q-item-section avatar top>
      <q-avatar size="36px">
        <q-img :src="AvatarPlaceHolder128" />
      </q-avatar>
    </q-item-section>
    <q-item-section>
      <q-item-label lines="1">
        <span class="cursor-pointer text-weight-bold">Chanavee Bekaku</span>
        <span class="text-muted text-caption q-ml-sm">June 28 at 8:40 PM</span>
      </q-item-label>
      <q-item-label>
        <div
          :class="
      ...
      <q-item-label lines="1">
        <div class="row q-my-sm">
          <div class="q-pr-sm">
            <base-app-link label="Love it" class="text-caption" />
            <span class="q-mx-sm">
              <q-icon :name="biHeart" />
          ...
          <div class="q-pl-sm">
            <base-app-link label="Reply it" class="text-caption" />
            <span class="q-mx-sm">
              <span class="text-caption text-muted q-ml-xs">1.9k</span>
            </span>
          </div>
