<template>
  <div :class="$q.screen.gt.sm ? 'q-mx-md' : ''">
    <q-scroll-area
    ...
    >
      ...
      <feed-section-saved-post v-if="$q.screen.gt.sm" />
      <feed-section-followwing-tag v-if="$q.screen.gt.sm" class="q-mt-md" />
    </q-scroll-area>
  </div>
</template>
